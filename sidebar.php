<div id="sidebar" class="col-md-4">
    ...
    <div class="recent-post-container">
        ...
        <?php
                include "config.php";
                $limit=3;
          $sql="SELECT post.post_id, post.title, post.description,post.post_date,category.category_name,post.category,post.author,post.post_img FROM post
                    LEFT JOIN category ON post.category=category.category_id
                   ORDER BY post.post_id DESC LIMIT {$limit}";
                   $result=mysqli_query($conn,$sql) or die('Query error : Recentect post');
